...
const handleSizeChange = () => {
  innerPagination.value!.pageNum = 1;
...
<template>
  <div class="flex flex-col h-full">
    ...
    <el-table :data="tableData" class="grow">
    ...
    <el-pagination v-if="innerPagination" class="mt-3 ml-auto" v-model:current-page="innerPagination.pageNum"
