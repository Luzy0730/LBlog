            ...
            <div class="ui segment m-box m-padded-tb-large m-margin-bottom-big">
              <div class="ui middle aligned mobile reversed stackable">
                <div class="ui grid m-margin-lr">
                  ...
                  <!--分类-->
                  <span :style="colorStyle(blogExtraInfo.category!.color)" class="ui large ribbon label m-hover-dark">
                  ...
                  <div class="typo m-padded-tb-small line-numbers" ref="docRef"
                    v-html="descriptionHtml ? descriptionHtml : contentHtml">
                  </div>
                  <!--横线-->
                  ...
                  <div class="row m-padded-tb-no">
                    <div class="column m-padding-left-no">
                      <span class="ui tag label m-text-500 m-margin-small m-hover-dark" :style="colorStyle(tag.color)"
                        v-for="tag in blogExtraInfo.tags" :key="tag.id">{{ tag.name }}</span>
                    </div>
                  </div>
                </div>
              </div>
