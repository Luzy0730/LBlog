...
<template>
  <el-row justify="space-between">
    ...
    <el-col :span="8">
      <el-button type="primary" class="float-right" @click="onCreateArticle"
        >新增</el-button
      >
      <el-button type="primary" class="float-right mr-3" @click="onQueryArticle"
        >刷新</el-button
      >
    </el-col>
  </el-row>
  <el-table :data="tableData" class="mt-5">
    ...
    >
      <template #default="{ row }">
        <el-button type="primary" link @click="onUpdateArticle(row)"
          >编辑</el-button
        >
